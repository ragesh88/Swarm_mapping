//
// Created by ragesh on 2/17/20.
//

/**
 MILevywalker_Alberto_merger.cpp

 This is a source code for a plugin for the stage simulator.
 The plugin enables the robot to perform MILevy walk in a bounded domain,
 ...
 protocol.
 The primary purpose of the plugin is to generate data for comparing our map
 merging strategy with the map merging strategy in Alberto's strategy in paper
 "A real-time map merging strategy for robust collaborative reconstruction
