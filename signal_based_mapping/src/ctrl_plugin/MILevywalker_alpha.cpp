//
// Created by ragesh on 10/8/19.
//

/**
 MILevywalker_alpha.cpp
 ...
 protocol.
 The primary purpose of the plugin is to generate data for studying the effect of the Levy
 walk parameter alpha on the coverage attained.
**/
